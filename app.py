...
#inverting the image 
    img_bin = 255-img_bin
    cv2.imwrite('./img_to_text/cv_inverted.png',img_bin)
...
#Use vertical kernel to detect and save the vertical lines in a jpg
    ...
    cv2.imwrite("./img_to_text/vertical.jpg",vertical_lines)
...
#Use horizontal kernel to detect and save the horizontal lines in a jpg
    ...
    cv2.imwrite("./img_to_text/horizontal.jpg",horizontal_lines)
#Plot the generated image
...
#Eroding and thesholding the image
    mg_vh = cv2.erode(~img_vh, kernel, iterations=2)
    thresh, img_vh = cv2.threshold(img_vh,128,255, cv2.THRESH_BINARY | cv2.THRESH_OTSU)
    cv2.imwrite("./img_to_text/img_vh.jpg", img_vh)
...
#Converting it in a excel-file
    data.to_excel("./img_to_text/output.xlsx")
